...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 24
    answer = sum_of_digits(9429)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 5
    answer = sum_of_digits(500000)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 22
    answer = sum_of_digits(12847)
...
def run_test_digits_in_cube():
    ...
    print('Cube Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 8
    answer = digits_in_cube(5)
    print('Cube Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_digits_in_power():
    ...
    print('Power Test 1 expected:', expected)
    print('       actual:  ', answer)

    expected = 13
    answer = digits_in_power(7,2)
    print('Power Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 9
    answer = digits_in_power(9, 2)
    print('Power Test 3 expected:', expected)
    print('       actual:  ', answer)
